return {
    {
        ...
        opts = {
            ...
            sources = {
                "filesystem",
                "buffers", -- using telescope (<space>b)
                "document_symbols",
                "git_status",
            },
            ...
            resize_timer_interval = -1, -- in ms (default 500), needed for containers to redraw right aligned and faded content
            ...
            window = { -- see https://github.com/MunifTanjim/nui.nvim/tree/main/lua/nui/popup for
                ...
                mappings = {
                    ...
                    -- ["t"] = "open_tabnew",  -- default in
                    -- ["<cr>"] = "open_drop",
                    -- ["t"] = "open_tab_drop",
                    -- ["w"] = "open_with_window_picker",  -- missing dependency
                    ["C"] = "close_node",
                    ["z"] = "close_all_nodes",
                    --["Z"] = "expand_all_nodes",
                    ["R"] = "refresh",
            ...
            filesystem = {
                ...
                --  return args
                --end,
                group_empty_dirs = true, -- (default: false) when true, empty folders will be grouped together
                search_limit = 20, -- (default: 50); max number of search results when using filters
                follow_current_file = {
